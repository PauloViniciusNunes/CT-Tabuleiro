...
const Sidebar: React.FC<SidebarProps> = ({ tokens, addToken, updateToken, removeToken }) => {
  ...
  return (
    <>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {activeTab === 'token' && (
            <div className="flex flex-col h-full">
              <h2 className="text-lg font-bold text-white select-none mb-2">Biblioteca de Tokens</h2>
              <button
          ...
          {activeTab === 'item' && (
            <div className="flex flex-col h-full">
              <h2 className="text-lg font-bold text-white select-none mb-2">Itens</h2>
              <button
          ...
          {activeTab === 'music' && (
            <div className="flex flex-col h-full">
              <h2 className="text-lg font-bold text-white select-none mb-2">Músicas</h2>
              <button
          ...
          {activeTab === 'chat' && (
            <div className="flex flex-col h-full">
              <h2 className="text-lg font-bold text-white select-none mb-2">Battle Historic Chat</h2>
              <div className="flex-1 overflow-y-auto bg-gray-800 rounded p-2 mb-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-4 py-2 bg-green-600 hover:bg-green-700 rounded text-white text-sm font-bold">
                  Enviar
                </button>
              </div>
            </div>
      ...
      {formOpen && (
        <TokenForm
          onSave={token => { addToken(token); setFormOpen(false); }}
