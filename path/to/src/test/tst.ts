function setTransformerAdd(v1: number[], v2: number[]): number[] {
...
function complemento<T>(A: Set<T>, B: Set<T>): Set<T> {
 ...
 * @returns 
 */
function setTransformerRemove(p: number[], I: number[], vi: number[][]): number[] {
...
console.info("Teste de Agente"); // Adicionado
